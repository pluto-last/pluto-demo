...
var file_HelloWorld_proto_rawDesc = []byte{
	...
	0x79, 0x22, 0x00, 0x12, 0x27, 0x0a, 0x07, 0x53, 0x6f, 0x6d, 0x65, 0x52, 0x50, 0x43, 0x12, 0x0d,
...
var file_HelloWorld_proto_depIdxs = []int32{
	...
	0, // 1: Greeter.SomeRPC:input_type -> HelloRequest
	1, // 2: Greeter.SayHello:output_type -> HelloReply
	1, // 3: Greeter.SomeRPC:output_type -> HelloReply
...
type GreeterClient interface {
	...
	SomeRPC(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error)
}
...
func (c *greeterClient) SomeRPC(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/Greeter/SomeRPC", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	...
	SomeRPC(context.Context, *HelloRequest) (*HelloReply, error)
}
...
func (*UnimplementedGreeterServer) SomeRPC(context.Context, *HelloRequest) (*HelloReply, error) {
...
func _Greeter_SomeRPC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).SomeRPC(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Greeter/SomeRPC",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).SomeRPC(ctx, req.(*HelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SomeRPC",
			Handler:    _Greeter_SomeRPC_Handler,
		},
	},
